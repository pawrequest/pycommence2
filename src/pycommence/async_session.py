...
pycommence API safe to use from ``asyncio`` code (FastAPI, NiceGUI,
MCP servers, etc.).
...
class AsyncCommenceSession:
    """Async facade over :class:`~pycommence.session.CommenceSession`.
    ...
    async def watch(
        ...
        *,
        ...
        while True:
            ...
            from pycommence.models import WatchEvent
