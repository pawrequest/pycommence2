"""CLI for pycommence2 — powered by click + rich.
...
Usage::
    ...
    pycommence2 read Hire --limit 20 --format table
    pycommence2 count Hire --filter "Name:Contains:Smith"
"""
...
def cli(verbose: bool) -> None:
    """pycommence2 — Commence database tools from the command line."""
...
def mcp(read_only: bool, transport: str, port: int) -> None:
    ...
    Examples:
        ...
        pycommence2 mcp --transport sse --port 9000
    """
    try:
        from pycommence2.mcp_server import _build_server, _check_mcp_installed
    except ImportError:
        raise click.ClickException(
